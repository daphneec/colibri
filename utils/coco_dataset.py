...
class COCODataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        logging.info('=> num_images: {}'.format(self.num_images))
    ...
    def _load_coco_person_detection_results(self):
        ...
        if not all_boxes:
            logging.error('=> Load %s fail!' % self.bbox_file)
            return None

        logging.info('=> Total boxes: {}'.format(len(all_boxes)))
        ...
        logging.info('=> Total boxes after fliter low score@{}: {}'.format(
    ...
    def evaluate(self, preds, output_dir, all_boxes, img_path,
        ...
        if not os.path.exists(res_folder):
            try:
                ...
                logging.error('Fail to make {}'.format(res_folder))
    ...
    def _write_coco_keypoint_results(self, keypoints, res_file):
        ...
        logging.info('=> writing results json to %s' % res_file)
